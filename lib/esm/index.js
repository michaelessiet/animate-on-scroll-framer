...
import React__default, { createContext, useContext, useLayoutEffect, useEffect, useState, useRef, useCallback, useMemo, forwardRef, createElement } from 'react';
...
var FlipIn = function (_a) {
    ...
    var animateEachChildSeperately = function () {
        return (children &&
            React__default.Children.map(children, function (child) { return (jsx("div", __assign({ ref: ref, style: { perspective: "600px", overflowX: 'clip', overflowY: 'visible' } }, { children: jsx(motion.div, __assign({ initial: "initial", transition: {
                        delay: defaultdelay,
                        duration: defaultduration,
                        type: defaultAnimaitionType,
...
var AnimateOnScroll = function (_a) {
    ...
    var animations = {
        fadeIn: (jsx(FadeIn, __assign({ duration: duration, delay: delay, spring: spring, animateEachChild: animateEachChild }, { children: children }))),
        fadeInUp: (jsx(FadeInUp, __assign({ duration: duration, delay: delay, spring: spring, animateEachChild: animateEachChild }, { children: children }))),
        fadeInDown: (jsx(FadeInDown, __assign({ duration: duration, delay: delay, spring: spring, animateEachChild: animateEachChild }, { children: children }))),
        fadeInLeft: (jsx(FadeInLeft, __assign({ duration: duration, delay: delay, spring: spring, animateEachChild: animateEachChild }, { children: children }))),
        fadeInRight: (jsx(FadeInRight, __assign({ duration: duration, delay: delay, spring: spring, animateEachChild: animateEachChild }, { children: children }))),
        slideInRight: (jsx(SlideInRight, __assign({ duration: duration, delay: delay, spring: spring, animateEachChild: animateEachChild }, { children: children }))),
        slideInLeft: (jsx(SlideInLeft, __assign({ duration: duration, delay: delay, spring: spring, animateEachChild: animateEachChild }, { children: children }))),
        slideInUp: (jsx(SlideInUp, __assign({ duration: duration, delay: delay, spring: spring, animateEachChild: animateEachChild }, { children: children }))),
        scaleIn: (jsx(ScaleIn, __assign({ duration: duration, delay: delay, spring: spring, animateEachChild: animateEachChild }, { children: children }))),
        flipIn: (jsx(FlipIn, __assign({ duration: duration, delay: delay, spring: spring, animateEachChild: animateEachChild }, { children: children }))),
        scaleInX: (jsx(ScaleInX, __assign({ duration: duration, delay: delay, spring: spring, animateEachChild: animateEachChild }, { children: children }))),
        scaleInY: (jsx(ScaleInY, __assign({ duration: duration, delay: delay, spring: spring, animateEachChild: animateEachChild }, { children: children }))),
    };
    ...
    return (jsx(motion.div, __assign({ style: { width: "100%" } }, { children: animationHandler() })));
};
