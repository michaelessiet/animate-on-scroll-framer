...
var FlipIn = function (_a) {
    ...
    var animateEachChildSeperately = function () {
        return (children &&
            React__default["default"].Children.map(children, function (child) { return (jsxRuntime.jsx("div", __assign({ ref: ref, style: { perspective: "600px", overflowX: 'clip', overflowY: 'visible' } }, { children: jsxRuntime.jsx(motion.div, __assign({ initial: "initial", transition: {
                        delay: defaultdelay,
                        duration: defaultduration,
                        type: defaultAnimaitionType,
...
var AnimateOnScroll = function (_a) {
    ...
    var animations = {
        fadeIn: (jsxRuntime.jsx(FadeIn, __assign({ duration: duration, delay: delay, spring: spring, animateEachChild: animateEachChild }, { children: children }))),
        fadeInUp: (jsxRuntime.jsx(FadeInUp, __assign({ duration: duration, delay: delay, spring: spring, animateEachChild: animateEachChild }, { children: children }))),
        fadeInDown: (jsxRuntime.jsx(FadeInDown, __assign({ duration: duration, delay: delay, spring: spring, animateEachChild: animateEachChild }, { children: children }))),
        fadeInLeft: (jsxRuntime.jsx(FadeInLeft, __assign({ duration: duration, delay: delay, spring: spring, animateEachChild: animateEachChild }, { children: children }))),
        fadeInRight: (jsxRuntime.jsx(FadeInRight, __assign({ duration: duration, delay: delay, spring: spring, animateEachChild: animateEachChild }, { children: children }))),
        slideInRight: (jsxRuntime.jsx(SlideInRight, __assign({ duration: duration, delay: delay, spring: spring, animateEachChild: animateEachChild }, { children: children }))),
        slideInLeft: (jsxRuntime.jsx(SlideInLeft, __assign({ duration: duration, delay: delay, spring: spring, animateEachChild: animateEachChild }, { children: children }))),
        slideInUp: (jsxRuntime.jsx(SlideInUp, __assign({ duration: duration, delay: delay, spring: spring, animateEachChild: animateEachChild }, { children: children }))),
        scaleIn: (jsxRuntime.jsx(ScaleIn, __assign({ duration: duration, delay: delay, spring: spring, animateEachChild: animateEachChild }, { children: children }))),
        flipIn: (jsxRuntime.jsx(FlipIn, __assign({ duration: duration, delay: delay, spring: spring, animateEachChild: animateEachChild }, { children: children }))),
        scaleInX: (jsxRuntime.jsx(ScaleInX, __assign({ duration: duration, delay: delay, spring: spring, animateEachChild: animateEachChild }, { children: children }))),
        scaleInY: (jsxRuntime.jsx(ScaleInY, __assign({ duration: duration, delay: delay, spring: spring, animateEachChild: animateEachChild }, { children: children }))),
    };
    ...
    return (jsxRuntime.jsx(motion.div, __assign({ style: { width: "100%" } }, { children: animationHandler() })));
};
